...
- **Add book's title and author**
- **Remove book's title and author**
...
Feel free to check the [issues page](https://github.com/PabloBona/Awesome-books-with-ES6/issues).
...
This project is [MIT](https://github.com/PabloBona/Awesome-books-with-ES6/blob/main/MIT.md) licensed.
